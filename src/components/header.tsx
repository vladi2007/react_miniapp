        ...
        <div className="header_fon">
          <div className="header">
            ...
            <div className="header_nav">
              <NavLink to="/" className="header_nav_about_us">
                О нас
              </NavLink>
              <div className="header_nav_organization_settings">
                ...
                {orgs && (
                  <div className="header_nav_item-dropdown-options">
                    <div className="header_nav_item-dropdown-options-header">Выберите организацию:</div>
              ...
              <NavLink to="/user" className="header_nav_user">
                @{user?.username}
              </NavLink>
